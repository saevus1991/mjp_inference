...
void init_ssa(pybind11::module_ &m){
    ...
    m.def("simulate_batched", simulate_batched,
        ...
        pybind11::arg("max_events") = 100000,
        pybind11::arg("max_event_handler") = "warning");
    m.def("simulate_posterior", static_cast<pybind11::dict (*)(MEInference*, ObservationModel*, np_array_c, np_array_c, np_array_c, np_array_c, np_array_c, np_array_c, np_array_c, int, int, std::string)>(&simulate_posterior),
        ...
        pybind11::arg("max_events") = 100000,
        pybind11::arg("max_event_handler") = "warning");
    m.def("simulate_posterior_batched", simulate_posterior_batched,
        pybind11::arg("master_equation"), 
        pybind11::arg("obs_model"),
        pybind11::arg("initial_dist"),
        pybind11::arg("rates"),

...
class KrylovBackwardFilter():
    def __init__(self, master_equation: MEInference, obs_model: ObservationModel, obs_times: numpy.ndarray[numpy.float64, _Shape[m, 1]], observations: numpy.ndarray[numpy.float64, _Shape[m, 1]], initial: numpy.ndarray[numpy.float64, _Shape[m, 1]], rates: numpy.ndarray[numpy.float64, _Shape[m, 1]], obs_param: numpy.ndarray[numpy.float64, _Shape[m, 1]], tspan: numpy.ndarray[numpy.float64, _Shape[m, 1]]) -> None: ...
    def backward_filter(self) -> None: ...
    @typing.overload
    def eval_backward_filter(self, time: float) -> numpy.ndarray[numpy.float64, _Shape[m, 1]]: ...
    @typing.overload
    def eval_backward_filter(self, time: numpy.ndarray[numpy.float64, _Shape[m, 1]]) -> numpy.ndarray[numpy.float64, _Shape[m, n]]: ...
    @typing.overload
    def eval_forward_filter(self, time: float) -> numpy.ndarray[numpy.float64, _Shape[m, 1]]: ...
    @typing.overload
    def eval_forward_filter(self, time: numpy.ndarray[numpy.float64, _Shape[m, 1]]) -> numpy.ndarray[numpy.float64, _Shape[m, n]]: ...
    @typing.overload
    def eval_smoothed(self, time: float) -> numpy.ndarray[numpy.float64, _Shape[m, 1]]: ...
    @typing.overload
    def eval_smoothed(self, time: numpy.ndarray[numpy.float64, _Shape[m, 1]]) -> numpy.ndarray[numpy.float64, _Shape[m, n]]: ...
    def forward_filter(self) -> None: ...
    def get_initial_smoothed(self) -> numpy.ndarray[numpy.float64, _Shape[m, 1]]: ...
...
class NoiseModel():
    ...
    def sample(self, seed: int = 3381144360) -> numpy.ndarray[numpy.float64, _Shape[m, 1]]: ...
    @property
...
class NormalNoise(NoiseModel):
    ...
    pass
class LogNormalNoise(NormalNoise, NoiseModel):
    def __init__(self, exp_mu: numpy.ndarray[numpy.float64, _Shape[m, 1]], sigma: numpy.ndarray[numpy.float64, _Shape[m, 1]]) -> None: ...
    pass
class ObservationModel():
    ...
    def transform(self, time: float, state: numpy.ndarray[numpy.float64, _Shape[m, 1]], param: numpy.ndarray[numpy.float64, _Shape[m, 1]], name: str) -> numpy.ndarray[numpy.float64, _Shape[m, 1]]: ...
    def transform_vec(self, time: float, param: numpy.ndarray[numpy.float64, _Shape[m, 1]], name: str) -> numpy.ndarray[numpy.float64, _Shape[m, n]]: ...
    @property
